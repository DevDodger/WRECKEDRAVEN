...
local function EWIIPG_fake_script() -- ServerNotifi.Script 
...
local function BSFYC_fake_script() -- Credit.Script 
...
local function EDZUKT_fake_script() -- Spawn.Script 
	local script = Instance.new('Script', Spawn)

	script.Parent.MouseButton1Click:connect(function(GetCar)
		Mod = game.ServerStorage.TTPPluginAdmins.LoadUsers     -- Change test to whatever you have named the item you want to spawn.
		clone = Mod:clone()
